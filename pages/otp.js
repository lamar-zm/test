...
import loginIllustration from "../public/assests/login2.svg";
        ...
        <div className="h-[80%] w-full flex items-center justify-center">
          <div className="h-[90%] w-[80%] flex items-center rounded-xl">
            ...
            <div className="h-[85%] w-[50%] flex items-center justify-center">
              <div className="h-[80%] w-full  p-3 flex flex-col items-end justify-evenly">
                ...
                <div className="h-[40%] flex flex-col justify-center gap-8">
                  <div className="flex gap-2">
                    <div className="relative">
                      <input
                        className="border bg-transparent py-9 px-3 w-[449px] text-xl rounded-lg outline-none relative"
                        type="tel"
                        name="phone"
                        id="phone-input"
                        dir="rtl"
                      ...
                      />
                      <span className="right-3 top-1 absolute text-lg font-semibold ">رقم الهاتف</span>
                    </div>
